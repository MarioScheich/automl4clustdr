...
```
cd existing_repo
git remote add origin https://gitlab-as.informatik.uni-stuttgart.de/scheicmo/automl4clustdr.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab-as.informatik.uni-stuttgart.de/scheicmo/automl4clustdr/-/settings/integrations)
